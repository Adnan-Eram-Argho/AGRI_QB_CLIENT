  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center py-12">
        <h1 className="text-4xl font-bold mb-4">Agricultural Economics Question Bank</h1>
        <p className="text-xl text-gray-400 mb-8">
          A platform for Agricultural University Economics students to share and access past exam questions
        </p>
